...
def _item(source: dict, title: str, summary: str, link: str,
    ...
    return {
        ...
        "tarih": tarih,
        # trusted: kelime puanlamasını atlar, doğrudan aday olur
        # direct : aynısı + mesajda "resmi duyuru" olarak etiketlenir
        ...
        # otorite: kaynağın kendi ağırlığı. Tagesschau'nun "Türkei"si ile
        # yerel gazetenin "Türkei"si aynı şey değil.
        "otorite": int(source.get("otorite", 0) or 0),
    }
...
def fetch_html(source: dict, url: str) -> list[dict]:
    ...
    link + link metni topluyoruz; ilgili mi kararını puanlama veriyor."""
